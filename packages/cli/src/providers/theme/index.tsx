import {mkdir, mkdirSync, readFile, readFileSync, writeFile, writeFileSync} from 'node:fs';
...
const CONFIG_DIR = join(homedir(), '.whalincode');
...
function persistTheme(theme: Theme) {
    try {
        ...
        //Ignora preferenes write failures so theme switching stills works
    };
};
