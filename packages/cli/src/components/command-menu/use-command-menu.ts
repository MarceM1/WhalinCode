...
export function useCommandMenu(): UseCommandMenuReturn {
    ...
    const handleContentChange = (text: string) => {
        ...
        // Jump to top of the list when the user type a new character
    ...
    // Arrow key navigation in the selection; the list follows along when thehighlight goes off-screen
    useKeyboard((key) => {
        ...
        if (key.name === 'escape') {
            ...
            setSelectedIndex((i: number) => {
                ...
                // Keep the highlighted item visible when arrowingpast the edge
